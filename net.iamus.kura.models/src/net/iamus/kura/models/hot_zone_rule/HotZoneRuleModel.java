package net.iamus.kura.models.hot_zone_rule;

import java.sql.Date;

public class HotZoneRuleModel {
	private int id;
	...
	HotZoneRuleModel(int id, String zoneRuleId, int zoneRuleVersion, int requiredEquipment, Date allowedTime,
